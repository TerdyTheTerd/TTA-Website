...
(function($) {
    $.imageCrop = function(object, customOptions) {
        ...
        function setSelection(event) {
            ...
            options.selectionPosition[0] = Math.round(selectionOrigin[0]);
        ...
        function resizeSelection(event) {
            ...
            if (options.selectionWidth < 0) {
                ...
                options.selectionPosition[0] = Math.round(selectionOrigin[0]) - options.selectionWidth;
            } else
        ...
        function releaseSelection(event) {
            ...
            selectionOrigin[0] = Math.round(options.selectionPosition[0]);
